...
## Corpus Check
- 33 files · ~16,032 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 142 nodes · 213 edges · 12 communities (10 shown, 2 thin omitted)
...
- `Navigation()` --calls--> `playModeSwitch()`  [EXTRACTED]
  src/components/Navigation.jsx → src/utils/audio.js
- `Navigation()` --calls--> `toggleSound()`  [EXTRACTED]
  src/components/Navigation.jsx → src/utils/audio.js
...
### Community 4 - "AeroLines.jsx"
Cohesion: 0.50
Nodes (3): AeroLines(), createFlowCurve(), FLOW_PATHS

### Community 6 - "CarPlaceholder.jsx"
Cohesion: 0.20
Nodes (14): CATEGORIES, ConfiguratorUI(), CarPlaceholder(), getExplodeAmount(), getTargetVehicleRotation(), lerpMaterialColor(), _tmpColor, useCarMaterials() (+6 more)
